...
Migrar el prototipo C a una aplicación web local, reproducible y verificable, conservando sus reglas actuales. Los defectos conocidos no se corregirán durante esta migración: se registrarán como desviaciones fieles pendientes de mejora posterior.
...
| `app-shell` | Experiencia local | Inicio de partida, selección de dificultad, ciclo de vida sin persistencia y conexión entre motor e interfaz. | `game-engine`, `web-interface` |
...
- Aplicación local, sin backend, cuentas, red, telemetría ni guardado.
